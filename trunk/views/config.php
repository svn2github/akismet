							...
							<tbody>
								...
								<tr>
									...
									<td align="left">
										...
										<span class="akismet-note"><?php esc_html_e( 'To help your site be compliant with GDPR and other laws requiring notification of tracking, Akismet can display a notice to your users under your comment forms. This feature is disabled by default, however, if you or your audience are located in Europe, you need to turn it on.', 'akismet' );?></span>
									</td>
								</tr>
							</tbody>
						</table>
