...
<div class="notice notice-warning is-dismissible" id="akismet-privacy-notice-admin-notice">
	...
	<p><?php printf( __(' Please <a href="%s">enable</a> or <a href="%s">disable</a> this feature. <a href="%s" id="akismet-privacy-notice-control-notice-info-link" target="_blank">More information</a>.', 'akismet' ), admin_url( 'options-general.php?page=akismet-key-config&akismet_comment_form_privacy_notice=display' ), admin_url( 'options-general.php?page=akismet-key-config&akismet_comment_form_privacy_notice=hide' ), 'https://en.support.wordpress.com/automattic-gdpr/' ); ?></p>
</div>
<?php endif;?>
